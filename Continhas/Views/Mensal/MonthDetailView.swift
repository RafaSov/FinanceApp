...
// Tela de detalhes do mês - ATUALIZADO com form de entrada melhorado
...
struct IncomeFormView: View {
    ...
    // Formata entrada de moeda enquanto digita (com separador de milhar)
    private func formatCurrencyInput(_ input: String) -> String {
        ...
        // Usa NumberFormatter para formatar com separador de milhar
    ...
    // Formata valor para edição (com separador de milhar)
